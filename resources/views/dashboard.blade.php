        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h3 class="text-lg font-bold text-gray-900">Menu Akses Cepat</h3>
                        <p class="text-sm text-gray-500 mt-1">Klik salah satu menu untuk menuju ke halaman terkait.</p>
                    </div>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach([
                                [
                                    'name' => 'Makanan',
                                    'desc' => 'Kelola daftar makanan yang tersedia di FoodMarket',
                                ...
                                [
                                    'name' => 'User',
                                    'desc' => 'Lihat dan kelola seluruh pengguna terdaftar',
                                ...
                                [
                                    'name' => 'Transaksi',
                                    'desc' => 'Pantau dan kelola seluruh transaksi penjualan',
                                ...
                                [
                                    'name' => 'Profil',
                                    'desc' => 'Lihat dan perbarui informasi profil akun Anda',
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="p-2.5 rounded-full {{ $menu['color'] }} mr-4">
                                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">{!! $menu['icon'] !!}</svg>
                                            </div>
                                            <span class="font-semibold text-gray-900">{{ $menu['name'] }}</span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-sm text-gray-500">{{ $menu['desc'] }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right">
                                        <a href="{{ $menu['route'] }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-lg hover:bg-indigo-700 active:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-colors duration-150">
                                            Buka
